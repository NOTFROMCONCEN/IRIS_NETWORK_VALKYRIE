...
class ConfigValidator:
    ...
    CONFIG_SCHEMA = {
        ...
        "system": {
            ...
            "subkeys": {
                ...
                "log_level": {"type": str, "options": ["DEBUG", "INFO", "WARNING", "ERROR"], "default": "INFO"},
                "max_workers_precheck": {"type": int, "min": 1, "max": 100, "default": 20},
                "max_workers_batch": {"type": int, "min": 1, "max": 50, "default": 5},
                "disk_space_check_mb": {"type": int, "min": 10, "max": 10000, "default": 100},
            ...
            "subkeys": {
                ...
                "log_rotation": {
                    ...
                    "subkeys": {
                        ...
                        "max_bytes": {"type": int, "min": 1024, "max": 104857600, "default": 10485760},
                        "backup_count": {"type": int, "min": 1, "max": 30, "default": 7},
    ...
    def _validate_key(self, key: str, schema: Dict[str, Any], config: Dict[str, Any], parent_key: str = ""):
        """
        验证单个配置项
        ...
        if expected_type and not isinstance(value, expected_type):
            self.errors.append(f"配置项 {full_key} 类型错误: 期望 {expected_type.__name__}, 实际 {type(value).__name__}")
            return
        ...
        # 验证路径
        if expected_type == str and "dir" in key.lower():
